...
export default function Xiaomi() {
  return (
    <div className="min-h-screen text-white">
      <SEO
        title="Serwis Xiaomi Kielce | Naprawa telefonów Xiaomi"
        description="Serwis Xiaomi w Kielcach. Naprawa telefonów Xiaomi, wymiana wyświetlacza, baterii, złącza ładowania, aparatu, głośnika oraz naprawy po zalaniu."
        canonical="https://sellfix.pl/serwis/android/xiaomi"
      />
      ...
      <main className="mx-auto max-w-7xl px-5 py-20">
        ...
        <section className="mb-12">
          ...
          <h1 className="text-5xl font-black md:text-6xl">
            Serwis Xiaomi Kielce
          </h1>

          <p className="mt-6 max-w-3xl text-lg leading-8 text-zinc-300">
            Naprawiamy telefony Xiaomi: Xiaomi, Redmi, POCO oraz seria Mi. Wykonujemy diagnozę,
        ...
        <section className="mt-16">
          <div className="mb-8">
            ...
            <h2 className="text-4xl font-black md:text-5xl">
              Najczęstsze naprawy telefonów Xiaomi
            </h2>

            <p className="mt-4 max-w-3xl text-lg leading-8 text-zinc-300">
              Poniżej znajdziesz usługi, które najczęściej wykonujemy
              przy telefonach Xiaomi. Dokładną cenę podajemy po diagnozie
