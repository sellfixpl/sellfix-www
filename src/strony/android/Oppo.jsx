...
export default function Oppo() {
  return (
    <div className="min-h-screen text-white">
      <SEO
        title="Serwis Oppo Kielce | Naprawa telefonów Oppo"
        description="Serwis Oppo w Kielcach. Naprawa telefonów Oppo, wymiana wyświetlacza, baterii, złącza ładowania, aparatu, głośnika oraz naprawy po zalaniu."
        canonical="https://sellfix.pl/serwis/android/oppo"
      />
      ...
      <main className="mx-auto max-w-7xl px-5 py-20">
        ...
        <section className="mb-12">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-zinc-300">
            Naprawiamy telefony Oppo: Oppo Reno, A, Find oraz inne serie. Wykonujemy diagnozę,
        ...
        <section className="mt-16">
          <div className="mb-8">
            ...
            <h2 className="text-4xl font-black md:text-5xl">
              Najczęstsze naprawy telefonów Oppo
            </h2>

            <p className="mt-4 max-w-3xl text-lg leading-8 text-zinc-300">
              Poniżej znajdziesz usługi, które najczęściej wykonujemy
              przy telefonach Oppo. Dokładną cenę podajemy po diagnozie
