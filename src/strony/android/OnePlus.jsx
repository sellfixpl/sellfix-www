...
export default function OnePlus() {
  return (
    <div className="min-h-screen text-white">
      <SEO
        title="Serwis OnePlus Kielce | Naprawa telefonów OnePlus"
        description="Serwis OnePlus w Kielcach. Naprawa telefonów OnePlus, wymiana wyświetlacza, baterii, złącza ładowania, aparatu, głośnika oraz naprawy po zalaniu."
        canonical="https://sellfix.pl/serwis/android/oneplus"
      />
      ...
      <main className="mx-auto max-w-7xl px-5 py-20">
        ...
        <section className="mb-12">
          ...
          <h1 className="text-5xl font-black md:text-6xl">
            Serwis OnePlus Kielce
          </h1>

          <p className="mt-6 max-w-3xl text-lg leading-8 text-zinc-300">
            Naprawiamy telefony OnePlus: OnePlus Nord oraz flagowe serie OnePlus. Wykonujemy diagnozę,
        ...
        <section className="mt-16">
          <div className="mb-8">
            ...
            <h2 className="text-4xl font-black md:text-5xl">
              Najczęstsze naprawy telefonów OnePlus
            </h2>

            <p className="mt-4 max-w-3xl text-lg leading-8 text-zinc-300">
              Poniżej znajdziesz usługi, które najczęściej wykonujemy
              przy telefonach OnePlus. Dokładną cenę podajemy po diagnozie
        ...
        <section className="mt-16 rounded-3xl border border-lime-400/20 bg-zinc-900 p-8">
          <h2 className="text-3xl font-black md:text-4xl">
            Chcesz wycenić naprawę OnePlus?
          </h2>
