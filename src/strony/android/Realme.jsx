...
export default function Realme() {
  return (
    <div className="min-h-screen text-white">
      <SEO
        title="Serwis Realme Kielce | Naprawa telefonów Realme"
        description="Serwis Realme w Kielcach. Naprawa telefonów Realme, wymiana wyświetlacza, baterii, złącza ładowania, aparatu, głośnika oraz naprawy po zalaniu."
        canonical="https://sellfix.pl/serwis/android/realme"
      />
      ...
      <main className="mx-auto max-w-7xl px-5 py-20">
        ...
        <section className="mb-12">
          ...
          <h1 className="text-5xl font-black md:text-6xl">
            Serwis Realme Kielce
          </h1>

          <p className="mt-6 max-w-3xl text-lg leading-8 text-zinc-300">
            Naprawiamy telefony Realme: Realme GT, Number, C oraz Narzo. Wykonujemy diagnozę,
        ...
        <section className="mt-16">
          <div className="mb-8">
            ...
            <h2 className="text-4xl font-black md:text-5xl">
              Najczęstsze naprawy telefonów Realme
            </h2>

            <p className="mt-4 max-w-3xl text-lg leading-8 text-zinc-300">
              Poniżej znajdziesz usługi, które najczęściej wykonujemy
              przy telefonach Realme. Dokładną cenę podajemy po diagnozie
